...
describe 'School' do
  ...
  describe "#add_student" do
    ...
    it 'is able to add students to different grades' do
      ...
      expect(@school.roster).to eq({9 => ["Homer Simpson"], 10 => ["AC Slater", "Jeff Baird", "Blake Johnson", "Jeff Baird", "Avi Flombaum"], 7 => ["Blake Johnson"]})
    end
  end
  ...
  describe '#grade' do
    it 'is able to retreive students from a grade' do
      ...
      expect(@school.grade(10)).to eq(["AC Slater", "Jeff Baird", "Blake Johnson", "Jeff Baird", "Avi Flombaum", "Avi Flombaum", "Jeff Baird"])
    end
  end
  ...
  describe "#sort" do
    it 'is able to sort the students' do
      ...
      expect(@school.sort).to eq({7 => ["Blake Johnson", "Blake Johnson", "Blake Johnson", "Jack Bauer"], 9 => ["Bart Simpson", "Homer Simpson", "Homer Simpson", "Homer Simpson"], 10 => ["AC Slater", "Avi Flombaum", "Avi Flombaum", "Avi Flombaum", "Blake Johnson", "Jeff Baird", "Jeff Baird", "Jeff Baird", "Jeff Baird"]})
    end
  end
end
