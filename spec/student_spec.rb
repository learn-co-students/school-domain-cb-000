...
describe 'School' do
  ...
  describe '#sort' do
    it 'is able to sort the students' do
      ...
      # key order does not matter; this is testing that
      # the students in each respective value are in alphabetical order
      expect(@school.sort).to eq(7 => ['Blake Johnson', 'Jack Bauer'],
